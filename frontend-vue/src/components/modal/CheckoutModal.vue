...
// // // Emit the updated contact data to parent
...
// // addContact method to handle form submission
// const addContact = () => {
...
//   // Emit the contact data to parent component
//   emit('update-contact', newContact);

//   // Reset form after submission
//   resetForm();
// };

// // Reset the form fields when modal is opened (if needed)
// const resetForm = () => {
//   name.value = '';
//   phone.value = '';
//   location.value = '';
