            ...
            <div class="col-lg-12">
              <div class="product-details-frame">
                <div class="tab-descrip">
                  Omnis eum unde itaque doloribus officia sunt. Sunt repellendus
                  velit qui aperiam earum deleniti sed. Omnis esse reprehenderit
                  esse velit dolorem. Optio in impedit numquam sed placeat
                  dolorem.
                </div>
              </div>
            </div>
              ...
              <div class="product-details-frame">
                <ul class="review-list">
                  <li class="review-item">
                    <div class="review-media">
                      <a class="review-avatar" href="#"
                        ><img src="@/assets/images/product/01.jpg" alt="review"
                      /></a>
                  ...
                  <li class="review-item">
                    <div class="review-media">
                      <a class="review-avatar" href="#"
                        ><img src="@/assets/images/product/04.jpg" alt="review"
                      /></a>
                      <h5 class="review-meta">
